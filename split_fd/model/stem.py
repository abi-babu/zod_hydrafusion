...
class RFHeatStem(Stem):
    def __init__(
        ...
        super(RFHeatStem, self).__init__(block, layers, pretrained)


class RFSpectoStem(Stem):
    def __init__(
        self, 
        block: Type[Union[BasicBlock, Bottleneck]],
        layers: List[int],
        ...
        super(RFSpectoStem, self).__init__(block, layers, pretrained)
